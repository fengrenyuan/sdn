			...
			$.ajax({
				...
				success: function(flow_m){
					...
					var series1 = chart.series[0],
						...
						shift1  = series1.data.length > 7,
						shift2  = series2.data.length > 7,
						point1 = [Date.now()+3600*8000, parseInt(flow_m.flow)];
						point2 = [Date.now()+3600*8000, parseInt(flow_m.flow2)];
					//add a point
					chart.series[0].addPoint(point1, true, shift1);
